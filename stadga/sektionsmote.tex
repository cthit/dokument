...
\begin{itemize}
	...
	\item Behandlande av uppdragsfrihet för sektionskommittéer.
\end{itemize}
...
Om styrelsen önskar ta upp en proposition ska denna anslås enligt \paragraphref{sec:protokoll:anslagning} senast sju läsdagar före sektionsmötet.  
\end{comment}
