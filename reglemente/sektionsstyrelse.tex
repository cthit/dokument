...
\begin{itemize}
	...
	\item sekreterare
	\item SAMO
    \item studerandeskyddsombud (SSO)
	\item 0-2 ledamöter.
\end{itemize} 
...
\begin{att}
    ...
    \item Arbeta aktivt med att förbättra arbetsmiljön och företräda studenterna på sektionen i arbetsmiljöfrågor, bland annat genom Psykosociala skyddsronder.
...
\subsubsection{Det åligger \STYRIT{}s SSO}
    \begin{att}
        \item vara skyddsombud över skyddsområde kandidatprogrammet Informationsteknik och tillhörande masterprogram.
        \item delta i högskolans systematiska arbetsmiljöarbete, vilket inkluderar planering, undersökning, riskbedömning och uppföljning av studenters arbetsmiljö.  
        \item företräda studenterna gentemot högskolan i fysiska och organisatoriska arbetsmiljöfrågor, bland annat genom Fysiska skyddsronder.
        \item medverka vid arbetsmiljöutbildningar anordnade av högskolan.  
        \item representera sektionen på kårens utskott för SSO.
    \end{att} 
