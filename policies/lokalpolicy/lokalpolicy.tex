...
\section{Boka}
Sektionens olika lokaler får bokas efter kl. 17:00 på studiedagar samt dygnet runt på helger. Sektionens lokaler får endast bokas 9 veckor framåt i tiden. Styrelsen samt lokalansvarig kommitté har rätt att häva bokningar om de ej anses lämpliga.\\\\
Undantag: 
\begin{enumerate}
    \item Från tentaperiodens första dag kl. 08:00 till dess sista dag kl 13:00 får \HUBBEN{} endast bokas för studierelaterade arrangemang.
    \item Under mottagningen ansvarar mottagningskommittén, i samråd med styrelsen och den lokalansvariga kommittén, för bokningar av \HUBBEN{}.
    \item Styrelsen får medge ytterligare undantag om det anses lämpligt.
\end{enumerate}
